...
typedef int PyGSL_sf_ufunc_pi_id_rd_one(int, double, gsl_sf_result *);
void PyGSL_sf_ufunc_pi_id_rd (char **args, PyGSL_array_index_t *dimensions, PyGSL_array_index_t *steps, void *func){
...
void PyGSL_sf_ufunc_pi_if_rf_as_id_rd (char **args, PyGSL_array_index_t *dimensions, PyGSL_array_index_t *steps, void *func){
	PyGSL_array_index_t i,  is0=steps[0] , is1=steps[1] , os0=steps[2] , os1=steps[3] , os2=steps[4] ;
	char   *ip0=args[0] , *ip1=args[1] , *op0=args[2] , *op1=args[3] , *op2=args[4] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		DEBUG_MESS(2, "Evaluating element %ld", (long)i);
...
typedef int PyGSL_sf_ufunc_pi_idd_rd_one(int, double, double, gsl_sf_result *);
void PyGSL_sf_ufunc_pi_idd_rd (char **args, PyGSL_array_index_t *dimensions, PyGSL_array_index_t *steps, void *func){
...
void PyGSL_sf_ufunc_pi_iff_rf_as_idd_rd (char **args, PyGSL_array_index_t *dimensions, PyGSL_array_index_t *steps, void *func){
	PyGSL_array_index_t i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , os0=steps[3] , os1=steps[4] , os2=steps[5] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *op0=args[3] , *op1=args[4] , *op2=args[5] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		DEBUG_MESS(2, "Evaluating element %ld", (long)i);
...
void PyGSL_sf_ufunc_pi_ifff__as_iddd_ (char **args, PyGSL_array_index_t *dimensions, PyGSL_array_index_t *steps, void *func){
	...
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ){
		DEBUG_MESS(2, "Evaluating element %ld", (long)i);
		*(int *)op0 = ((PyGSL_sf_ufunc_pi_iddd__one *) func)( *((int *)ip0) , (double)*((float *)ip1) , (double)*((float *)ip2) , (double)*((float *)ip3) );
	}
}

typedef int PyGSL_sf_ufunc_pi_iidd_rd_one(int, int, double, double, gsl_sf_result *);
void PyGSL_sf_ufunc_pi_iidd_rd (char **args, PyGSL_array_index_t *dimensions, PyGSL_array_index_t *steps, void *func){
...
void PyGSL_sf_ufunc_pi_iiff_rf_as_iidd_rd (char **args, PyGSL_array_index_t *dimensions, PyGSL_array_index_t *steps, void *func){
	PyGSL_array_index_t i,  is0=steps[0] , is1=steps[1] , is2=steps[2] , is3=steps[3] , os0=steps[4] , os1=steps[5] , os2=steps[6] ;
	char   *ip0=args[0] , *ip1=args[1] , *ip2=args[2] , *ip3=args[3] , *op0=args[4] , *op1=args[5] , *op2=args[6] ;
	for(i = 0; i<dimensions[0]; i++ ,ip0+=is0 ,ip1+=is1 ,ip2+=is2 ,ip3+=is3 ,op0+=os0 ,op1+=os1 ,op2+=os2 ){
		DEBUG_MESS(2, "Evaluating element %ld", (long)i);
