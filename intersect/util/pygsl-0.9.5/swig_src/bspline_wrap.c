...
static PyMethodDef SwigMethods[] = {
	 { (char *)"bspline_cov_get", _wrap_bspline_cov_get, METH_VARARGS, (char *)"bspline_cov_get(struct pygsl_bspline self) -> gsl_matrix_view"},
	 { (char *)"bspline_coeffs_get", _wrap_bspline_coeffs_get, METH_VARARGS, (char *)"bspline_coeffs_get(struct pygsl_bspline self) -> gsl_vector_view"},
	 { (char *)"bspline_tmp_get", _wrap_bspline_tmp_get, METH_VARARGS, (char *)"bspline_tmp_get(struct pygsl_bspline self) -> gsl_vector_view"},
	 { (char *)"bspline_w_get", _wrap_bspline_w_get, METH_VARARGS, (char *)"bspline_w_get(struct pygsl_bspline self) -> gsl_bspline_workspace"},
	 { (char *)"bspline_knots_a_get", _wrap_bspline_knots_a_get, METH_VARARGS, (char *)"bspline_knots_a_get(struct pygsl_bspline self) -> PyArrayObject"},
	 { (char *)"bspline_coeffs_a_get", _wrap_bspline_coeffs_a_get, METH_VARARGS, (char *)"bspline_coeffs_a_get(struct pygsl_bspline self) -> PyArrayObject"},
	 { (char *)"bspline_cov_a_get", _wrap_bspline_cov_a_get, METH_VARARGS, (char *)"bspline_cov_a_get(struct pygsl_bspline self) -> PyArrayObject"},
	 { (char *)"bspline_tmp_a_get", _wrap_bspline_tmp_a_get, METH_VARARGS, (char *)"bspline_tmp_a_get(struct pygsl_bspline self) -> PyArrayObject"},
	 { (char *)"new_bspline", (PyCFunction) _wrap_new_bspline, METH_VARARGS | METH_KEYWORDS, (char *)"new_bspline(size_t K, size_t NBREAK) -> struct pygsl_bspline"},
	 { (char *)"delete_bspline", _wrap_delete_bspline, METH_VARARGS, (char *)"delete_bspline(struct pygsl_bspline self)"},
	 { (char *)"bspline_get_internal_knots", _wrap_bspline_get_internal_knots, METH_VARARGS, (char *)"bspline_get_internal_knots(struct pygsl_bspline self) -> PyObject"},
	 { (char *)"bspline_knots", (PyCFunction) _wrap_bspline_knots, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_knots(struct pygsl_bspline self, PyObject knots_o) -> gsl_error_flag_drop"},
	 { (char *)"bspline_knots_uniform", (PyCFunction) _wrap_bspline_knots_uniform, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_knots_uniform(struct pygsl_bspline self, double a, double b) -> gsl_error_flag_drop"},
	 { (char *)"bspline_eval_vector", (PyCFunction) _wrap_bspline_eval_vector, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_eval_vector(struct pygsl_bspline self, gsl_vector IN) -> PyObject"},
	 { (char *)"bspline_eval", (PyCFunction) _wrap_bspline_eval, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_eval(struct pygsl_bspline self, double X) -> PyObject"},
	 { (char *)"bspline_set_coefficients_and_covariance_matrix", (PyCFunction) _wrap_bspline_set_coefficients_and_covariance_matrix, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_set_coefficients_and_covariance_matrix(struct pygsl_bspline self, PyObject coeffs_o, PyObject cov_o) -> gsl_error_flag_drop"},
	 { (char *)"bspline_eval_dep", (PyCFunction) _wrap_bspline_eval_dep, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_eval_dep(struct pygsl_bspline self, double x, double OUT) -> gsl_error_flag_drop"},
	 { (char *)"bspline_eval_dep_vector", (PyCFunction) _wrap_bspline_eval_dep_vector, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_eval_dep_vector(struct pygsl_bspline self, gsl_vector X) -> PyObject"},
	 { (char *)"bspline_eval_dep_yerr", (PyCFunction) _wrap_bspline_eval_dep_yerr, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_eval_dep_yerr(struct pygsl_bspline self, double x, double OUT, double OUT2) -> gsl_error_flag_drop"},
	 { (char *)"bspline_eval_dep_yerr_vector", (PyCFunction) _wrap_bspline_eval_dep_yerr_vector, METH_VARARGS | METH_KEYWORDS, (char *)"bspline_eval_dep_yerr_vector(struct pygsl_bspline self, gsl_vector X) -> PyObject"},
